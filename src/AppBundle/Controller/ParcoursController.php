...
class ParcoursController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('AppBundle:parcours:index.html.twig', array(
            'parcours' => $parcours,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('AppBundle:parcours:new.html.twig', array(
            'parcour' => $parcour,
    ...
    public function showAction(Parcours $parcour)
    {
        ...
        return $this->render('AppBundle:parcours:show.html.twig', array(
            'parcour' => $parcour,
    ...
    public function editAction(Request $request, Parcours $parcour)
    {
        ...
        return $this->render('AppBundle:parcours:edit.html.twig', array(
            'parcour' => $parcour,
